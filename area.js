(function () {
    var zone = {"0": [
        ...
        {"name": "\u9999\u574a\u533a", "code": 230106},
        {"name": "\u52a8\u529b\u533a", "code": 230107},
        ...
        {"name": "\u9a6c\u5858\u533a", "code": 340203},
        {"name": "\u65b0\u829c\u533a", "code": 340204},
        ...
        {"name": "\u6c5f\u6d25\u5e02", "code": 500381},
        {"name": "\u5408\u5ddd\u5e02", "code": 500382},
        {"name": "\u6c38\u5ddd\u5e02", "code": 500383},
        {"name": "\u5357\u5ddd\u5e02", "code": 500384}
    ], "510000": [
    ...
    /**
     *
     * @param address  包含省'市‘区’街道信息
     * @return zone[]  包含zone对象中的地区信息
     */
    zone.collect = function (address) {
        var result = [];
        var parts = extractAddress(address);
        var group = zone['0'];
        for (var i = 0; i < parts.length; i++) {
            var pos = findZoneByName(parts[i], group);
            if (pos != -1) {
                var matched = group[pos];
                result.push(matched);
                group = zone[matched.code];
                if (!group)
                     break;
            }
        }
    ...
    function extractAddress(address) {
        ...
        if (address.province == address.city) {
            parts = [address.city, address.district, address.street];
        } else {
            parts = [address.province, address.city, address.district, address.street];
        }
        return parts;
    }

    function findZoneByName(name, group) {
